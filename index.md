...
<div class="hero-overlay">
  <!--<div class="hero-logo"></div>-->
    ...
    <a class="legend" href="https://github.com/mlpack/mlpack/releases/tag/4.3.0">mlpack-4.3.0.tar.gz</a><br>
        <a href="files/mlpack-4.3.0.tar.gz">
...
<ul class="flex-container">
  ...
  <li class="flex-item">
    <a href="doc/mlpack-4.3.0/cli_documentation.html#tutorials">
      <div class="card">
