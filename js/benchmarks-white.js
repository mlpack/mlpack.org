...
var width = 400; // This should be parameterizable...
var height = 220; // This should be parameterizable...
var margin = { top: 20, right: 20, bottom: 120, left: 40 };

// Static bindings of library names to colors.
//var color = d3.scale.ordinal().range(["#98abc5", "#8a89a6", "#7b6888", "#6b486b", "#a05d56", "#d0743c", "#ff8c00"]);
var color = d3.scale.ordinal().range(["#a8cbe5", "#aaa9c6", "#9b88a8", "#8b688b", "#c07d76", "#f0945c", "#ffac20"]);
