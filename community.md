...
[Python bindings](doc/mlpack-4.0.1/python_documentation.html),
[R bindings](doc/mlpack-4.0.1/r_documentation.html),
[Julia bindings](doc/mlpack-4.0.1/julia_documentation.html), or the
[command-line programs](doc/mlpack-4.0.1/cli_documentation.html) to perform machine learning
tasks.  You can also write C++ programs to perform machine learning tasks with
mlpack; [here](doc/mlpack-4.0.1/doxygen/sample.html) are some basic examples.
...
source](doc/mlpack-4.0.1/doxygen/build.html) and [explore the
