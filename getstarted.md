...
### Build from source
- [Linux build tutorial](doc/mlpack-4.2.1/doxygen/build.html)

## Windows

### Download prebuilt binaries
- [Windows 64 bit - MSI Installer](/files/mlpack-4.2.1.msi)
- [Windows 64 bit - ZIP](/files/mlpack-4.2.1.zip)

### Install using a package manager
- [Installation through vcpkg](doc/mlpack-4.2.1/doxygen/build_windows.html)

### Build from source
- [Windows build tutorial](doc/mlpack-4.2.1/doxygen/build_windows.html)
