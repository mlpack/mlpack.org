...
[Python bindings](doc/mlpack-../python_documentation.html),
[Julia bindings](doc/mlpack-../julia_documentation.html), or the
[command-line programs](doc/mlpack-../cli_documentation.html) to perform machine learning
tasks.  You can also write C++ programs to perform machine learning tasks with
mlpack; [here](doc/mlpack-../doxygen/sample.html) are some basic examples.
...
source](doc/mlpack-../doxygen/build.html) and [explore the
